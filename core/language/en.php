...
$languageArray= [ "dripfeeds.title" => "Drip-feed", 
 ...
 "smmspot.addfunds.title" => "Add funds", 
 ...
 "smmspot.addfunds.last_payments" => "Last payments", 
 "smmspot.addfunds.last_payments_desc" => "You can see your payments here.", 
 ...
 "smmspot.neworder.submit.button" => "Buy service", 
 "smmspot.neworder.place.a.new.order.title" => "Choose The Service", 
 ...
 "smmspot.child.ns.title" => "Please set your NS:", 
 ...
 "cerulean.welcome" => "Welcome", 
 "cerulean.new_order.desc" => "You can choose us for the most affordable social media services.", 
 "cerulean.normal" => "Normal", 
 "cerulean.low" => "Low", 
 "ads" => "Ads", 
 "win_balance" => "Win balace", 
 "win_balance_desc" => "Our prices and rules are in the tables below", 
 "my_orders" => "My orders", 
 "my_orders_desc" => "Follow your current requests on this page.", 
 "platform" => "Platform", 
 "method" => "Method", 
 "price" => "Price", 
 "duration" => "Duration", 
 "day" => "Day", 
 "pos_comment" => "Positive comments", 
 "smmspot.neworder.balance.status" => "Balance status", 
 "links" => "Links", 
