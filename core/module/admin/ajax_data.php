                                                                                                ...
                                                                                                if ($action == "edit_paymentmethod" && $_POST["id"] == "coinpayments") {
                                                                                                    ...
                                                                                                    if ($action == "edit_paymentmethod" && $_POST["id"] == "paypal") {
                                                                                                        ...
                                                                                                        if ($action == "edit_paymentmethod" && $_POST["id"] == "paytm") {
                                                                                                            ...
                                                                                                            echo json_encode(['content' => $return, 'title' => '']);
                                                                                                        } elseif ($action == "edit_paymentmethod" && $_POST["id"] == "paymentv2") {
                                                                                                            $id = $_POST['id'];
                                                                                                            ...
                                                                                                            $is_active = (int) $method['method_type'];
                                                                                                            $is_demo = (int) $extra['is_demo'];
                                                                                                                ...
                                                                                                                <div class="modal-body">
                                                                                                                    ...
                                                                                                                    <div class="service-mode__block">
                                                                                                                        <div class="form-group">
                                                                                                                            <label>Visibility</label>
                                                                                                                            <select class="form-control" name="method_type">
                                                                                                                                <option value="2" ' . ($is_active == 2 ? 'selected' : '') . '>Active</option>
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="form-group__service-name">phoneangpao</label>
                                                                                                                        <input type="text" class="form-control" name="phoneangpao" value="' . $extra['phoneangpao'] . '">

                                                                                                                        <label class="form-group__service-name">imageqrcode</label>
                                                                                                                        <input type="text" class="form-control" name="imageqrcode" value="' . $extra['imageqrcode'] . '">
                                                                                                                        
                                                                                                                        <label class="form-group__service-name">accbank</label>
                                                                                                                        <input type="text" class="form-control" name="accbank" value="' . $extra['accbank'] . '">
