        ...
        <div class="input-group w-100">
          ...
          <span class="input-group-btn search-select-wrap w-100 mt-2">
            <select class="form-control search-select w-100" name="search_type">
              ...
              <option value="name" <?php if ($search_where == "name"): echo 'selected';
                                    endif; ?>>Name</option>
              <option value="email" <?php if ($search_where == "email"): echo 'selected';
                                    endif; ?>>Email</option>
              <option value="telephone" <?php if ($search_where == "telephone"): echo 'selected';
                                        endif; ?>>Phone number</option>
            </select>
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th>Username</th>
          <th>Email</th>
          <?php if ($settings["skype_area"] == 2): echo " <th>Phone number</th>";
          endif; ?>
          <th>Balance</th>
          <th>spent</th>
          <th>Status</th>
      ...
      <tbody>
        ...
        <?php foreach ($clients as $client):  ?>
          <tr class="<?php if ($client["client_type"] == 1): echo "grey";
                      endif; ?>">
            ...
            <?php if ($settings["skype_area"] == 2): echo "<td data-label='Phone number'>";
            ...
            <td data-label="Status"><?php if ($client["client_type"] == 2): echo "Activate";
                                    else: echo "Suspend";
                                    endif; ?></td>
            ...
            <td data-label="Special Price"><button type="button" class="btn btn-default btn-xs <?php if (!countRow(["table" => "clients_price", "where" => ["client_id" => $client["client_id"]]])): echo "disabled";
                                                                                                endif; ?> " style="cursor:pointer" data-toggle="modal" data-target="#modalDiv" data-id="<?php echo $client["client_id"] ?>" data-action="price_user">Set Discount
            ...
            <td class="td-caret" data-label="Action">
              <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu">
                  ...
                  <?php if ($client["client_type"] == 1): $type = "active";
                  else: $type = "deactive";
                  endif; ?>
                  <li><a href="<?php echo site_url("admin/clients/" . $type . "/" . $client["client_id"]) ?>"><?php if ($client["client_type"] == 1): echo "Activate account";
                                                                                                        else: echo "Suspend account";
                                                                                                        endif; ?> </a></li>
