   ...
   <div class="col-md-8">
      ...
      <table class="table report-table" style="border:1px solid #ddd">
         <thead>
            <tr>
               <th>
                  <div style="float:left;">Language Name</div>
               </th>
               <th>Status</th>
               <th></th>
            </tr>
         ...
         <tbody>
            <?php foreach ($languageList as $language): ?>
               <tr class="<?php if ($language["language_type"] == 1): echo 'grey';
                           endif; ?>">
                  <td>
                     <div style="float:left;"> <?php echo $language["language_name"];
                                                if ($language["default_language"] == 1): echo ' <span class="badge">Active</span>';
                                                endif; ?></div>
                  </td>

                  <?php if ($language["language_type"] == 2): ?>
                     <td>
                        <div class="tt" style="font-size: 1.5em;"> <a href="<?php echo site_url('admin/appearance/language/?lang-id=' . $language["language_code"] . '&lang-type=1') ?>"><span class="tt-icon tt-switch-color" style="color: rgb(0, 102, 255);"><i class="tt-switch-on"></i></span></a></div>
                     </td>
                  <?php endif; ?>
                  ...
                  <?php if ($language["language_type"] == 1): ?>
                     <td>
                        <div class="tt" style="font-size: 1.5em;"> <a href="<?php echo site_url('admin/appearance/language/?lang-id=' . $language["language_code"] . '&lang-type=2') ?>"><span class="tt-icon tt-switch-color" style="color: rgb(153, 153, 153);"><i class="tt-switch-off"></i></span></a></div>
                     </td>
                  <?php endif; ?>
            ...
            <div class="language-editor__container-footer">
               <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                     ...
                     <button type="submit" id="edit-language-btn" class="btn btn-primary" name="save-button">Update</button>
                     <a href="/admin/appearance/language" class="btn btn-default">Back</a>
                  </div>
               </div>
            </div>
         </form>
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="language-editor__header">
            <div class="row">
               <div class="language-editor__header-title">
                  <div class="col-md-6">

                     <strong><?php echo $language["language_name"] ?></strong>
                     <?php if ($language["default_language"] == 1): echo ' <span class="badge">Aktif</span>';
                     endif; ?>
                  ...
                  <div class="col-md-6 text-right">
                     <div class="pull-right">
                        <input class="form-control" placeholder="Kelime ara..." id="myInput" onkeyup="myFunction()" type="text" value="">
                     </div>
                  </div>
