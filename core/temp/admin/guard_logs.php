   ...
   <div class="row">
      ...
      <div class="col-lg-12">
         ...
         <div class="alert alert-info">
            Delete the protection logs you see in order to remove the warnings from the menu.!
            <hr>
            The number of protection logs appears in the menu as a warning so that important situations are not overlooked.
         </div>
                        ...
                        <tbody>
                           ...
                           <?php foreach ($logs as $log): ?>
                              <tr>
                                 ...
                                 <td><?php $s = $log["ip"];
                                       echo "<a href='https://ipapi.co/$s/json/'><i class='fa fa-search'></i> view </a>"; ?></td>
